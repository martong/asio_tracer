...
public:
  ...
  basic_yield_context(
      ...
      caller_type& ca, Handler& handler, coro_id parent_coro_id)
    : coro_(coro),
      ca_(ca),
      handler_(handler),
      ec_(0),
      parent_coro_id_(parent_coro_id)
  {
  }
...
#include <aim/asio/impl/spawn.hpp>
